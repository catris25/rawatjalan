      ...
      <ul>
       ...
       <div class="col-md-12">
         <form class="form-horizontal" role="form" method="POST" action="{{ url('pasien/tambah') }}">
              ...
              <div class="row">
  							<div class="input-field col s12">
                  <textarea id="alergi" class="validate materialize-textarea" name="alergi" value="{{ old('alergi') }}"></textarea>
              ...
              <div class="row">
  							<div class="input-field col s12">
                  <textarea id="riwayat_penyakit" class="validate materialize-textarea" name="riwayat_penyakit" value="{{ old('riwayat_penyakit') }}"></textarea>
